...
`sonoff.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`sonoff.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/sonoff.ino.globals.h into the folder above.
