...
#define SDA -1 // To defeat a check in the Wire library that fails compile if there is no PIN_WIRE_SDA and SDA
  ...
  #error "This board has no settings in sonoff.ino.globals.h. Select one of the boards this example supports, or add a section for yours to its platformio.ini and re-run scripts/generate_platform_h.py. Configured here: ARDUINO_ESP8266_SONOFF_BASIC"
#endif
