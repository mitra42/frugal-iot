...
`all.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`all.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/all.ino.globals.h into the folder above.
