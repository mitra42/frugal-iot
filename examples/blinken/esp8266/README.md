...
`blinken.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`blinken.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/blinken.ino.globals.h into the folder above.
