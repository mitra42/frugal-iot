...
`ensaht.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`ensaht.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/ensaht.ino.globals.h into the folder above.
