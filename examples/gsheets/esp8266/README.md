...
`gsheets.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`gsheets.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/gsheets.ino.globals.h into the folder above.
