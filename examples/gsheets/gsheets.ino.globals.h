...
// ===== LORA BOARDS - ALL ESP32 ======================================
  ...
  #error "This board has no settings in gsheets.ino.globals.h. Select one of the boards this example supports, or add a section for yours to its platformio.ini and re-run scripts/generate_platform_h.py. Configured here: ARDUINO_ESP8266_WEMOS_D1MINIPRO, ARDUINO_ESP8266_WEMOS_D1MINI"
#endif
