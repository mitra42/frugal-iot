...
`ms5803.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`ms5803.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/ms5803.ino.globals.h into the folder above.
