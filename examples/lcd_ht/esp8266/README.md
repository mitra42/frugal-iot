...
`lcd_ht.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`lcd_ht.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/lcd_ht.ino.globals.h into the folder above.
