...
// Boilerplate copied from examples/sht30/platformio.ini
...
#define SYSTEM_LORAMESHER_MODULE LoraMesher::LoraModules::SX1276_MOD
...
#define ARDUINO_LOLIN_C3_PICO // if using C3_PICO use lolin_c3_mini as board and define here// board_build.partitions = huge_app.csv
...
// build_flags =
//     ${common.build_flags}
#define SENSOR_SHT_ADDRESS 0x45
#define CONTROL_CLIMATE_DEBUG
#define SYSTEM_OTA_SUFFIX "d1_mini_45"
#endif // ARDUINO_ESP8266_WEMOS_D1MINI
