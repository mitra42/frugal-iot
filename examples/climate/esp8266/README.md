...
`climate.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`climate.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/climate.ino.globals.h into the folder above.
