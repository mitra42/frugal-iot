...
`power.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`power.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/power.ino.globals.h into the folder above.
