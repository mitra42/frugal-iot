...
`loadcell.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`loadcell.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/loadcell.ino.globals.h into the folder above.
