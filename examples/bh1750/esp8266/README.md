...
`bh1750.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`bh1750.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/bh1750.ino.globals.h into the folder above.
