...
`gps.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`gps.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/gps.ino.globals.h into the folder above.
