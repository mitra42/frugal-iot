...
// ===== LORA BOARDS - ALL ESP32 ======================================
  ...
  #error "This board has no settings in esp8266/soil.ino.globals.h. Under Tools > Board, select one of the boards this example supports, or add a section for yours to its platformio.ini and re-run scripts/generate_platform_h.py. Supported here: LOLIN(WEMOS) D1 mini Pro / LOLIN(WEMOS) D1 R2 & mini"
#endif
