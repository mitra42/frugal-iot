...
`remotedisplay.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`remotedisplay.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/remotedisplay.ino.globals.h into the folder above.
