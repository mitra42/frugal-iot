...
`datalogger.ino.globals.h` in this folder holds the settings (pins, addresses, debug flags) that
...
`datalogger.ino`:
    ...
    Sketch > Show Sketch Folder, then drag esp8266/datalogger.ino.globals.h into the folder above.
