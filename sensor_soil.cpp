...
Sensor_Soil::Sensor_Soil(const uint16_t map0_init, const uint16_t map100_init, const uint8_t pin_init, const uint8_t smooth_init, const char* topic_init, const unsigned long ms_init) : Sensor_Analog(pin_init, smooth_init, topic_init, ms_init) 
{ 
  map0 = map0_init;
  map100 = map100_init;
  Serial.print("XXX25 soil sensor on pin"); Serial.println(pin);
  Serial.print("XXX25 soil constructor map0="); Serial.print(map0);  Serial.print(" map100="); Serial.println(map100); 
...
uint16_t Sensor_Soil::read() {
  ...
  Serial.print("XXX25 soil read from pin"); Serial.println(x); 
  Serial.print("XXX25 soil map0="); Serial.print(map0);  Serial.print(" map100="); Serial.println(map100); 
