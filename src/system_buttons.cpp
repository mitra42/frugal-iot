...
void System_Buttons::setup() {
  ...
  readConfigFromFS(); // Reads config (none as of yet) and passes to our dispatch - should be after inputs and outputs setup (probably)
}

void System_Buttons::dispatch(System_Message &msg) {
