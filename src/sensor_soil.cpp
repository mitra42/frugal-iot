...
Sensor_Soil::Sensor_Soil(const char* const id, const char* name, const uint16_t map0_init, const uint16_t map100_init, const uint8_t pin_init, const uint8_t smooth_init, const char* color, const unsigned long ms_init, bool retain) 
