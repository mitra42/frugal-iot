...
#include "actuator/ledbuiltin.h" // for correct LED_BUILTIN
...
#include "system/frugal.h"
  ...
  // The certificate now lives in system/rootca.cpp - see rootca.h for why.
#endif
...
void System_OTA::setup_after_mqtt_setup() {
  ...
  #ifdef SYSTEM_OTA_USECERT
    init(url, SYSTEM_OTA_VERSION, rootCAForServer());
  #else
