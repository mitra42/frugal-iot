 ...
 */
 ...
 class Sensor_Button : public Sensor {
    public:
      Sensor_Button( const char * const name, const char* topicTwig, uint8_t pin);
      void setup();
      void loop();
      ...
      static void newSensor_Button(const char * const name, const char* topicTwig, uint8_t pin);
      static Sensor_Button* handler(Button2& button);
    private:
      Button2* button;
      uint8_t pin;
      const char* topicTwig;
 };
