...
/*
  ...
  System_Power_Mode_High* powerController(10000,10000);
#elif defined(SYSTEM_POWER_MODE_MEDIUM)
  System_Power_Mode_Medium* powerController(60000, 10000);
#elif defined(SYSTEM_POWER_MODE_LOW)
  System_Power_Mode_Low* powerController(60*60*1000, 30000);
#elif defined(SYSTEM_POWER_MODE_Auto)
  System_Power_Mode_Auto powerController(60000, 10000);
#else
