...
Sensor_Analog::Sensor_Analog(const char* name, const uint8_t p, const uint8_t smooth_init, const char* topic_init, uint16_t min, uint16_t max, const unsigned long ms_init, bool r) 
: Sensor_Uint16(name, smooth_init, topic_init, min, max, ms_init, r), pin(p) { };
