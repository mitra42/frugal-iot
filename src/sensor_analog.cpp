...
Sensor_Analog::Sensor_Analog(const char* const id, const char* name, const uint8_t p, const uint8_t smooth_init, uint16_t min, uint16_t max, const char* color, const unsigned long ms_init, bool r) 
