...
class Sensor_Analog : public Sensor_Uint16 {
  public: 
    ...
    Sensor_Analog(const char* const id, const char * const name, const uint8_t pin, const uint8_t smooth, uint16_t min, uint16_t max, const char* color, const unsigned long ms, bool retain);
    virtual void setup();
