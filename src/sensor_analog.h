...
class Sensor_Analog : public Sensor_Uint16 {
  public: 
    ...
    Sensor_Analog(const char* name, const uint8_t pin, const uint8_t smooth, const char* const topicLeaf, uint16_t min, uint16_t max, const char* color, const unsigned long ms, bool retain);
    virtual void setup();
