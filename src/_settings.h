...
// TO_ADD_CONTROL
#if defined(CONTROL_BLINKEN_DEBUG) || defined(CONTROL_HYSTERISIS_DEBUG) || defined(CONTROL_GSHEETS_DEBUG)
  #define CONTROL_DEBUG
#endif

#if defined(CONTROL_BLINKEN_WANT) || defined(CONTROL_HYSTERISIS_WANT) || defined(CONTROL_GSHEETS_WANT)
  #define CONTROL_WANT
#endif
