 ...
 * ITEAD_ARDUINO_ESP8266_SONOFF_BASIC SONOFF and ESP8266_D1 are inverted - 1 is off, 0 is on // TODO-141 confirm
...
#include "actuator/digital.h" // for class Actuator_Digital
