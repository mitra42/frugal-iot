...
Sensor_HT::Sensor_HT(const char* name, const char* topicLeafT, const char* topicLeafH, const unsigned long ms_init, boolean retain) 
  : Sensor(name, ms_init, retain), topicLeafT(topicLeafT), topicLeafH(topicLeafH), temperature(0), humidity(0) { }
